...
// import narendra from '../assets/demo.jpg';
export default function MessMembersDirectory() {
  ...
  return (
    <>
      <div className="min-h-screen bg-white p-18">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center gap-4 mb-12 flex-wrap">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full font-semibold transition-all duration-300 flex items-center gap-2 ${filter === 'manager'
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full font-semibold transition-all duration-300 flex items-center gap-2 ${filter === 'secretary'
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full font-semibold transition-all duration-300 flex items-center gap-2 ${filter === 'member'
